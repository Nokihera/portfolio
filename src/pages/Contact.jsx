  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (name.trim() && email.trim() && message.trim()) {
        ...
        toast.error("Please fill in all the fields."); // Notify user of empty fields
      }
    } catch (err) {
          ...
          <div className="text-center">
            <button
              ...
              className={`w-full px-6 py-3 ${
                loading ? "opacity-65" : "bg-yellow-400"
              } text-black font-semibold rounded-lg hover:bg-yellow-300 transition duration-300`}
            >
